    ...
    return (
      ...
      <div className='flex items-center justify-center'>
        <div className="container w-full mx-auto ">
          ...
          <h2 className="text-2xl font-semibold font-cabin">Phi Phi Island 1</h2>
          <nav className='flex justify-center'>
          <ol className="flex items-center space-x-2 breadcrumb">
            <li className="text-gray-200 breadcrumb-item">
              <a href="#">Home</a>
            </li>
            <li>
      ...
      <div className="container flex flex-col md:flex-row">
        {/* Tour Images Slider */}
        <div className="flex-auto w-full mt-10 md:w-64 ">
